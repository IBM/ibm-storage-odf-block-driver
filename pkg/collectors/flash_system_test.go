...
func poster(req *http.Request, c *rest.FSRestClient) ([]byte, int, error) {
	...
	switch path {
	case "/lssystem":
		body = `{"code_level": "8.4.0.2 (build 152.23.2102111856000)","product_name":"IBM SAN Volume Controller", "physical_capacity":"70727768211456", "physical_free_capacity":"37416452751360", "total_reclaimable_capacity":"0"}`
	case "/lssystemstats":
		body = `[
			{
