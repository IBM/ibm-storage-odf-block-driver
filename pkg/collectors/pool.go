...
func (f *PerfCollector) CalcReducedReclaimableCapacityForPool(pool Pool, fsRestClient *rest.FSRestClient) float64 {
	...
	if totalDisksCapacities == 0 || midSum == 0 {
		...
		return reclaimable / totalDisksCapacities * midSum
	}
}
