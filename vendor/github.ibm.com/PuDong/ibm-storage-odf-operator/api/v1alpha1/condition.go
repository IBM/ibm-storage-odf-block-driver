...
const (
	...
	// DefaultStorageClassCreated indicts a default storage class is created based on spec info
	DefaultStorageClassCreated ConditionType = "DefaultStorageClassCreated"
