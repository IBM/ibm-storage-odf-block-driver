...
Install the IBM® ODF FlashSystem driver through the [Red Hat OpenShift® certified operator catalog](https://catalog.redhat.com/software/search?type=Operator).
