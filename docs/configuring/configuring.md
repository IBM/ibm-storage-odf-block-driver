...
-   Support summary for enabled IBM Storage Virtualize® family products and Red Hat OpenShift Data Foundation®: [IBM® ODF FlashSystem driver support summary](../landing/odf_flashsystem_driver_support_matrix.html).
...
When creating block storage persistent volumes, be sure to select the storage class <storage_class_name> for best performance. The storage class allows a direct I/O path to the IBM FlashSystem® storage system.
